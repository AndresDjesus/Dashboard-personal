...
import { IconBarbell, IconFileSpreadsheet, IconTrash, IconAlarm } from '@tabler/icons-react';
...
function EjercicioSection() {
    ...
    useEffect(() => {
        ...
        // Muestra la notificación solo si hay al menos un registro previo
        if (records.length > 0) {
            ...
            if (now - lastRecordTime > oneDayInMilliseconds) {
                notifications.show({
                    ...
                    message: 'Hace más de 24 horas que no registras tu ejercicio. ¡Es un gran día para moverte!',
                    color: 'orange',
    ...
    // --- FIN DE LÓGICA DE RECORDATORIOS ---
            ...
            <Box style={{ position: 'relative', height: '300px', width: '100%' }} mb="md">
                {weeklyRecords && weeklyRecords.length > 0 ? (
                    ...
                    <Center style={{ height: '100%' }}>
                        <Text c="dimmed">Registra tus horas de entrenamiento para ver el gráfico.</Text>
                    </Center>
                )}
            </Box>
